...
### Task 2. Configure Voice flow to Transfer the call to Wholesale AI Agent. 
...
4. Connect **Case** node to **VirtualAgentV2**. Connect Handled output from **VirtualAgentV2** to the **DisconnectContact** node. Connect Escalate output from **VirtualAgentV2** to Queue that is configured with <w class="attendee"></w>_2000_Voice_Queue.
...
For your reference, please see the chat discussion with the Flower_WholeSale AI Agent. This will help you have a similar dialogue during your test call.
    ![Profiles](../graphics/Lab1_AI_Agent/14.13.png)
