...
1. Make sure you are in Editable mode of the flow. Click on the **VirtualAgentV2** node and open up the **State Event** option.
   ![Profiles](../graphics/Lab1_AI_Agent/13.1.gif)

2. Enter the following JSON data to the **Event Data** field: <copy>{"customer_name": "dear customer"}</copy>
   ![Profiles](../graphics/Lab1_AI_Agent/13.2.gif)

3. Validate and Publish the flow with the **Latest** tag.
...
2. In the **Welcome message** replace "there" with {{customer_name}}. In this case we expect that the caller will hear: Hi **dear customer**, my name is Blossom, the AI Agent. How can I assist you?
   ![Profiles](../graphics/Lab1_AI_Agent/13.5.gif) 

3. **Save changes** and **Publish** the flow. 
