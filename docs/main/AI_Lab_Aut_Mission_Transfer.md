...
4. Name the action as **<copy>Transfer_to_different_department</copy>**.<br/>
In the **Transfer condition** filed past **<copy>When the customer wants to transfer the call to HR or Billing department use this Action</copy>**.
...
6. Finally click on **Add** the new action. 
