...
### Task 1 <span style="color: red;">[READ ONLY]</span>. Review the upcoming UI for the Real-Time Topic Dashboard for Supervisors.  

1. When the Administrator login the the Agent Desktop then can see the Real Time Topic module. 
...
### Task 2 <span style="color: red;">[READ ONLY]</span>. Review Real-Time topic on the Supervisor's Dashboard. 

1. You can add **Topic** field the the Completed Interactions Dashboard. 
